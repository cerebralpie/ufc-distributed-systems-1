...
void updateState()
{
  ...
  device_state.distance.state = (state == DistanceState::CLOSE) ? DistanceData_State_CLOSE : (state == DistanceState::MEDIUM) ? DistanceData_State_MEDIUM
